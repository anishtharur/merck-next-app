  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <button
          onClick={() => window.history.back()}
          className="inline-flex items-center text-sm font-medium text-pharma-500 hover:text-pharma-700 mb-8 transition-colors group"
        >
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <div
                className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 mb-8 opacity-0 animate-fadeIn"
              ...
              <div
                className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 opacity-0 animate-fadeIn"
                ...
                <ul className="space-y-3">
                  {drug.sideEffects.map((effect, index) => (
                    <li key={index} className="flex items-start">
                      <span className="flex-shrink-0 h-5 w-5 bg-pharma-50 rounded-full flex items-center justify-center text-pharma-500 mr-3 mt-0.5">
                        <svg
                          className="h-3 w-3"
                          fill="currentColor"
                          viewBox="0 0 20 20"
            ...
            <div className="lg:col-span-1">
              <div
                className="bg-pharma-50 rounded-xl border border-pharma-100 p-6 sticky top-8 opacity-0 animate-fadeIn"
                style={{ animationDelay: "300ms" }}
              >
                <h3 className="text-lg font-medium text-pharma-800 mb-4 flex items-center">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="text-sm font-medium text-pharma-500 mb-1">
                      Status
                    </h4>
                    <p className="text-gray-800">{drug.status}</p>
                  </div>
                  ...
                  {drug.status === "In Development" && (
                    <div>
                      ...
                      <div className="flex items-center">
                        <div className="w-full bg-pharma-100 rounded-full h-2.5 mr-2">
                          <div
                            className="bg-pharma-500 h-2.5 rounded-full"
                            style={{
                  ...
                  {drug.status === "Approved" && (
                    <div className="pt-2">
                      <div className="bg-status-approved/10 border border-status-approved/20 rounded-lg p-4 flex items-start">
                  ...
                  {drug.status === "Discontinued" && (
                    <div className="pt-2">
                      <div className="bg-status-discontinued/10 border border-status-discontinued/20 rounded-lg p-4 flex items-start">
